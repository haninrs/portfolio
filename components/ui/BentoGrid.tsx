  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(80,80,97,1) 28%, rgba(164,179,182,1) 100%)",
      }}>
        ...
        <div className={`${id === 6 && 'flex justify-center'} h-full`}>
          ...
          <div className={`absolute right-0 -bottom-5 ${id === 5 && 'w-full opacity-80'}`}>
            ...
            <div className={cn(titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10')}>
              <div className="font-sans font-normal text-[#c1c2d3] text-sm md:text-xs dark:text-neutral-300 z-10">
                {description}
              </div>
            ...
            {id === 3 && (
              <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                ...
                <div className="flex flex-col gap-3 lg:gap-8">
                <span className="py-4 px-3 rounded-lg text-center bg-[#10132E]"/>
                  {['Express.js', 'Prisma ORM', 'MySQL', 'Rest API'].map((item) => (
                    <span
                    key={item}
                    className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                    >{item}</span>
